    ...
    <main className="absolute inset-0 flex items-center justify-center z-20">
      <div className="text-center max-w-4xl px-8">
        ...
        <div className="flex justify-center">
          <button className="px-12 py-5 rounded-full bg-white text-black font-normal text-lg transition-all duration-200 hover:bg-white/90 cursor-pointer shadow-lg hover:shadow-xl">
            Get Started
          </button>
        </div>
      </div>
